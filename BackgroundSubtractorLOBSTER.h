...
protected:
    ...
    std::vector<uint,Cxx11Utils::AlignAllocator<uint,32>> m_vnBGModelData;
    std::vector<RandUtils::TMT32GenParams,Cxx11Utils::AlignAllocator<RandUtils::TMT32GenParams,32>> m_voTMT32ModelData;
