...
for(int n=0; n<3; ++n) {
	...
	_res[n] = ((_absdiff(_val(-2, 2, n),_ref) > _t) << 15)
			+ ((_absdiff(_val( 2,-2, n),_ref) > _t) << 14)
			+ ((_absdiff(_val( 2, 2, n),_ref) > _t) << 13)
			+ ((_absdiff(_val(-2,-2, n),_ref) > _t) << 12)
			+ ((_absdiff(_val( 2, 0, n),_ref) > _t) << 11)
			+ ((_absdiff(_val( 0,-2, n),_ref) > _t) << 10)
			+ ((_absdiff(_val(-2, 0, n),_ref) > _t) << 9)
			+ ((_absdiff(_val( 0, 2, n),_ref) > _t) << 8)
			+ ((_absdiff(_val(-1,-1, n),_ref) > _t) << 7)
			+ ((_absdiff(_val( 1, 1, n),_ref) > _t) << 6)
			+ ((_absdiff(_val( 1,-1, n),_ref) > _t) << 5)
			+ ((_absdiff(_val(-1, 1, n),_ref) > _t) << 4)
			+ ((_absdiff(_val( 0, 1, n),_ref) > _t) << 3)
			+ ((_absdiff(_val( 0,-1, n),_ref) > _t) << 2)
			+ ((_absdiff(_val( 1, 0, n),_ref) > _t) << 1)
			+ ((_absdiff(_val(-1, 0, n),_ref) > _t));
}
