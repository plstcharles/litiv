...
//! defines the default value for BackgroundSubtractorViBe_1ch::m_nColorDistThreshold
#define BGSVIBE_DEFAULT_COLOR_DIST_THRESHOLD (20)
//! defines the default value for BackgroundSubtractorViBe_1ch::m_nBGSamples
#define BGSVIBE_DEFAULT_NB_BG_SAMPLES (20)
//! defines the default value for BackgroundSubtractorViBe_1ch::m_nRequiredBGSamples
#define BGSVIBE_DEFAULT_REQUIRED_NB_BG_SAMPLES (2)
//! defines the default value for the learning rate passed to BackgroundSubtractorViBe_1ch::operator() (the 'subsampling' factor in the original ViBe paper)
 ...
 */
class BackgroundSubtractorViBe_1ch : public cv::BackgroundSubtractor {
public:
	//! full constructor
	BackgroundSubtractorViBe_1ch(	int nColorDistThreshold=BGSVIBE_DEFAULT_COLOR_DIST_THRESHOLD,
