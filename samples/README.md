...
The samples presented here may rely only on data available in the [*data*](./data/) subdirectory (as defined by the **SAMPLES_DATA_ROOT** CMake variable), or on data provided by the user. This ensures all of them can run out-of-the-box without downloading any dataset. (The [*vptz*](./vptz/) and [*litiv2018viewer*](./litiv2018viewer/) samples are exceptions, as they tackle specific external datasets.)
