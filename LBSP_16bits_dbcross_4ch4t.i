...
//      _t              (size_t[4], absolute thresholds used for comparisons)
//      _ref            (uchar[4], 'central' values used for comparisons)
//      _data           (uchar*, quad-channel data to be covered by the pattern)
...
//      _res            (ushort[4], 16 bit result vectors vector)
