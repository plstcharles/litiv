...
macro(try_runcheck_and_set_success name)
    if(NOT (DEFINED USE_${name}))
        ...
        option(USE_${name} "Allow implementations to use ${name} instructions" ${USE_${name}})
        file(REMOVE ${CMAKE_CURRENT_BINARY_DIR}/cmake/checks/${name}.cpp)
    endif(NOT (DEFINED USE_${name}))
