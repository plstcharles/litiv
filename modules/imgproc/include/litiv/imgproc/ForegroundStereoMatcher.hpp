...
#define STEREOSEGMATCH_CONFIG_USE_MULTILEVEL_AFFIN  1 // @@@@@@@@@@
...
#define STEREOSEGMATCH_DEFAULT_DISCRIM_STDDEV_MIN   (1e-4)
#define STEREOSEGMATCH_DEFAULT_DISCRIM_SHP_RAD      (3)
...
#define STEREOSEGMATCH_IMGSIM_COST_DESC_SCALE       (2000)
#define STEREOSEGMATCH_SHPSIM_COST_DESC_SCALE       (2000)
