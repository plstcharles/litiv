...
namespace lv {
    ...
    protected:
        ...
        const bool m_bForcingGrayscale; ///< holds whether this work batch (and its children) should be treated as grayscale or not
        const IDataHandler& m_oParent; ///< holds a pointer to this work batch's parent
        const IDataHandler& m_oRoot; ///< holds a pointer to the dataset root
    };
