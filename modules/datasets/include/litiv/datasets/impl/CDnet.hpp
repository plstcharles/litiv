...
protected: // should still be protected, as creation should always be done via datasets::create
    Dataset_(
            ...
            IDataset_<eDatasetTask,eDatasetSource_Video,eDataset_CDnet,getDatasetEval<eDatasetTask,eDataset_CDnet>(),eEvalImpl>(
                    ...
                    PlatformUtils::AddDirSlashIfMissing(EXTERNAL_DATA_ROOT)+std::string(b2014?"CDNet2014/dataset/":"CDNet/dataset/"),
                    PlatformUtils::AddDirSlashIfMissing(EXTERNAL_DATA_ROOT)+std::string(b2014?"CDNet2014/":"CDNet/")+PlatformUtils::AddDirSlashIfMissing(sOutputDirName),
                    "bin",
                    ".png",
