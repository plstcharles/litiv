...
inline sospd::SubmodularIBFS<V,I>::SubmodularIBFS(const SubmodularIBFSParams& params)
        : m_params(params),
          m_flowSolver(std::move(sospd::GetSolver<V,I>(params)))
{ }

template<typename V, typename I>
inline typename sospd::SubmodularIBFS<V,I>::NodeId sospd::SubmodularIBFS<V,I>::AddNode(int n) {
    for (int i = 0; i < n; ++i)
...
template<typename V, typename I>
inline int sospd::SubmodularIBFS<V,I>::GetLabel(NodeId n) const {
    return m_labels[n];
}

template<typename V, typename I>
inline void sospd::SubmodularIBFS<V,I>::AddUnaryTerm(NodeId n, REAL E0, REAL E1) {
...
template<typename V, typename I>
inline void sospd::SubmodularIBFS<V,I>::AddUnaryTerm(NodeId n, REAL coeff) {
    AddUnaryTerm(n, 0, coeff);
}

template<typename V, typename I>
inline void sospd::SubmodularIBFS<V,I>::ClearUnaries() {
    m_graph.ClearTerminals();
}

template<typename V, typename I>
inline void sospd::SubmodularIBFS<V,I>::AddClique(const std::vector<NodeId>& nodes, const std::vector<REAL>& energyTable) {
    m_graph.AddClique(nodes, energyTable);
}

template<typename V, typename I>
inline void sospd::SubmodularIBFS<V,I>::AddPairwiseTerm(NodeId i, NodeId j, REAL E00, REAL E01, REAL E10, REAL E11) {
...
template<typename V, typename I>
inline typename sospd::SubmodularIBFS<V,I>::REAL sospd::SubmodularIBFS<V,I>::ComputeEnergy() const {
    return ComputeEnergy(m_labels);
}

template<typename V, typename I>
inline typename sospd::SubmodularIBFS<V,I>::REAL sospd::SubmodularIBFS<V,I>::ComputeEnergy(const std::vector<int>& labels) const {
...
template<typename V, typename I>
inline void sospd::SubmodularIBFS<V,I>::Solve() {
