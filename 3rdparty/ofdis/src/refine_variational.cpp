...
ofdis::VarRefClass::VarRefClass(const float * im_ao_in, const float * im_ao_dx_in, const float * im_ao_dy_in,
...
#if (SELECTCHANNEL==1 | SELECTCHANNEL==2)
void ofdis::VarRefClass::copyimage(const float* img, image_t * img_t) {
#else
void ofdis::VarRefClass::copyimage(const float* img, color_image_t * img_t) {
#endif
#if (SELECTCHANNEL==1|SELECTCHANNEL==2)
...
#if (SELECTCHANNEL==1 | SELECTCHANNEL==2)
void ofdis::VarRefClass::RefLevelOF(image_t *wx, image_t *wy, const image_t *im1, const image_t *im2) {
#else
void ofdis::VarRefClass::RefLevelOF(image_t *wx, image_t *wy, const color_image_t *im1, const color_image_t *im2) {
#endif
...
#if (SELECTCHANNEL==1 | SELECTCHANNEL==2)
void ofdis::VarRefClass::RefLevelDE(image_t *wx, const image_t *im1, const image_t *im2) {
#else
void ofdis::VarRefClass::RefLevelDE(image_t *wx, const color_image_t *im1, const color_image_t *im2) {
#endif
    int i_inner_iteration;
    int width  = wx->width;
    int height = wx->height;
