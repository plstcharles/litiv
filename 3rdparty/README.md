...
* [**googletest**](./3rdparty/googletest) : Contains the [Google Test](https://github.com/google/googletest) framework used for regression unit testing (created only when not already found on the system).
