...
_res= ((absdiff_uchar(_val(-2, 2),_ref) > _t) << 15)
	+ ((absdiff_uchar(_val( 2,-2),_ref) > _t) << 14)
	+ ((absdiff_uchar(_val( 2, 2),_ref) > _t) << 13)
	+ ((absdiff_uchar(_val(-2,-2),_ref) > _t) << 12)
	+ ((absdiff_uchar(_val( 2, 0),_ref) > _t) << 11)
	+ ((absdiff_uchar(_val( 0,-2),_ref) > _t) << 10)
	+ ((absdiff_uchar(_val(-2, 0),_ref) > _t) << 9)
	+ ((absdiff_uchar(_val( 0, 2),_ref) > _t) << 8)
	+ ((absdiff_uchar(_val(-1,-1),_ref) > _t) << 7)
	...
	+ ((absdiff_uchar(_val( 0,-1),_ref) > _t) << 2)
	+ ((absdiff_uchar(_val( 1, 0),_ref) > _t) << 1)
	+ ((absdiff_uchar(_val(-1, 0),_ref) > _t));
